...
int main()
{
  ...
  float planet_radius [9] = {2440e3,6051e3,6371e3,3389e3,71492e3,60268e3,25559e3,24764e3,1186e3};
  ...
  printf("What would you like to see? all_planet_masses, all_planet_orbits, specific_planet_data, planet_moons, all_planet_radius_smallg:\n");
  scanf("%s", what_to_do);
